  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        >
          ...
          <div className="flex items-end">
            <button
              ...
              className="w-full rounded-md bg-slate-950 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-50"
            >
        ...
        {suppliers.length === 0 && !isLoading && (
          <p className="mt-3 text-sm text-amber-700">
            Registra un proveedor antes de crear productos.
          </p>
        )}
      </section>
      ...
      <section className="rounded-xl border border-slate-200 bg-white shadow-sm">
        ...
        {message && (
          <p className="mx-5 mt-4 rounded-md bg-amber-50 px-3 py-2 text-sm text-amber-800">
            {message}
          </p>
        )}
